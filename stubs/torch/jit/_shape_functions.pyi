...
def embedding(weight: List[int], indices: List[int], padding_idx: int = ..., scale_grad_by_freq: bool = ..., sparse: bool = ...): ...
def max_int(): ...
def slice(self, dim: int, start: Optional[int], end: Optional[int], step: int): ...
...
def argmax(self, dim: Optional[int] = ..., keepdim: bool = ...) -> List[int]: ...
def bmm(self, mat2: List[int]) -> List[int]: ...
def topk(self, k: int, dim: int = ...) -> Tuple[List[int], List[int]]: ...
def nll_loss_forward(self, target: List[int], weight: Optional[List[int]], reduction: int) -> Tuple[List[int], List[int]]: ...
