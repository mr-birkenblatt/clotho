...
class RNNBase(Module):
    ...
    bidirectional: bool
    proj_size: int
    def __init__(self, mode: str, input_size: int, hidden_size: int, num_layers: int = ..., bias: bool = ..., batch_first: bool = ..., dropout: float = ..., bidirectional: bool = ..., proj_size: int = ..., device: Incomplete | None = ..., dtype: Incomplete | None = ...): ...
...
class RNNCellBase(Module):
    ...
    bias_ih: Incomplete
    bias_hh: Incomplete
    def __init__(self, input_size: int, hidden_size: int, bias: bool, num_chunks: int, device: Incomplete | None = ..., dtype: Incomplete | None = ...) -> None: ...
    def extra_repr(self) -> str: ...
    def reset_parameters(self) -> None: ...
...
class RNNCell(RNNCellBase):
    __constants__: Incomplete
    nonlinearity: str
    def __init__(self, input_size: int, hidden_size: int, bias: bool = ..., nonlinearity: str = ..., device: Incomplete | None = ..., dtype: Incomplete | None = ...) -> None: ...
    def forward(self, input: Tensor, hx: Optional[Tensor] = ...) -> Tensor: ...

class LSTMCell(RNNCellBase):
    def __init__(self, input_size: int, hidden_size: int, bias: bool = ..., device: Incomplete | None = ..., dtype: Incomplete | None = ...) -> None: ...
