...
class PContext(abc.ABC, metaclass=abc.ABCMeta):
    ...
    nprocs: Incomplete
    def __init__(self, name: str, entrypoint: Union[Callable, str], args: Dict[int, Tuple], envs: Dict[int, Dict[str, str]], stdouts: Dict[int, str], stderrs: Dict[int, str], tee_stdouts: Dict[int, str], tee_stderrs: Dict[int, str], error_files: Dict[int, str]) -> None: ...
    def start(self) -> None: ...
    def wait(self, timeout: float = ..., period: float = ...) -> Optional[RunProcsResult]: ...
    @abc.abstractmethod
    def pids(self) -> Dict[int, int]: ...
    def close(self, death_sig: Optional[signal.Signals] = ..., timeout: int = ...) -> None: ...
