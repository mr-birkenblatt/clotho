...
class HTMLFormatter(TableFormatter):
    ...
    def write_th(
            self, s: str, header: bool = ..., indent: int = ...,
            tags: Optional[str] = ...) -> None:
        ...

    def write_td(
            self, s: str, indent: int = ...,
            tags: Optional[str] = ...) -> None:
        ...

    def write_tr(
            self, line: List[str], indent: int = ...,
            indent_delta: int = ..., header: bool = ...,
            align: Optional[str] = ..., tags: Optional[Dict[int, str]] = ...,
            nindex_levels: int = ...) -> None:
        ...
