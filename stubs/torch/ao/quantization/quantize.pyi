...
def propagate_qconfig_(module, qconfig_dict: Incomplete | None = ..., prepare_custom_config_dict: Incomplete | None = ...) -> None: ...
def register_activation_post_process_hook(module, pre_hook: bool = ...) -> None: ...
def add_observer_(module, qconfig_propagation_list: Incomplete | None = ..., non_leaf_module_list: Incomplete | None = ..., device: Incomplete | None = ..., custom_module_class_mapping: Incomplete | None = ...): ...
def get_unique_devices_(module): ...
def add_quant_dequant(module): ...
def prepare(model, inplace: bool = ..., allow_list: Incomplete | None = ..., observer_non_leaf_module_list: Incomplete | None = ..., prepare_custom_config_dict: Incomplete | None = ...): ...
def quantize(model, run_fn, run_args, mapping: Incomplete | None = ..., inplace: bool = ...): ...
def quantize_dynamic(model, qconfig_spec: Incomplete | None = ..., dtype=..., mapping: Incomplete | None = ..., inplace: bool = ...): ...
def prepare_qat(model, mapping: Incomplete | None = ..., inplace: bool = ...): ...
def quantize_qat(model, run_fn, run_args, inplace: bool = ...): ...
def convert(module, mapping: Incomplete | None = ..., inplace: bool = ..., remove_qconfig: bool = ..., is_reference: bool = ..., convert_custom_config_dict: Incomplete | None = ...): ...
