...
def write_to_compressed(
        compression: Any, path: Any, data: Any,
        dest: str = ...) -> None:
    ...


def assert_almost_equal(
        left: Any, right: Any, check_dtype: str = ...,
...
def assert_categorical_equal(
        left: Any, right: Any, check_dtype: bool = ...,
...
def assert_timedelta_array_equal(
        left: Any, right: Any, obj: str = ...) -> None:
    ...


def raise_assert_detail(
        obj: Any, message: Any, left: Any, right: Any,
        diff: Optional[Any] = ...) -> None:
    ...


def assert_numpy_array_equal(
        left: Any, right: Any, strict_nan: bool = ...,
        check_dtype: bool = ...,
...
def makeCategoricalIndex(
        k: int = ..., n: int = ..., name: Optional[Any] = ...,
        **kwargs: Any) -> Any:
    ...


def makeIntervalIndex(
        k: int = ..., name: Optional[Any] = ...,
        **kwargs: Any) -> Any:
    ...
...
def makeRangeIndex(
        k: int = ..., name: Optional[Any] = ..., **kwargs: Any) -> Any:
    ...
...
def makeDateIndex(
        k: int = ..., freq: str = ..., name: Optional[Any] = ...,
        **kwargs: Any) -> Any:
    ...
...
def makeCustomIndex(
        nentries: Any, nlevels: Any, prefix: str = ...,
...
def makeCustomDataframe(
        nrows: Any, ncols: Any, c_idx_names: bool = ...,
...
def makeMissingCustomDataframe(
        nrows: Any, ncols: Any, density: float = ...,
...
def network(
        t: Any, url: str = ..., raise_on_error: Any = ...,
