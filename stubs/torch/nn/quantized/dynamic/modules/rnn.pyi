...
class RNNBase(torch.nn.Module):
    ...
    version: int
    training: bool
    def __init__(self, mode, input_size, hidden_size, num_layers: int = ..., bias: bool = ..., batch_first: bool = ..., dropout: float = ..., bidirectional: bool = ..., dtype=...) -> None: ...
    def extra_repr(self): ...
...
class RNNCellBase(torch.nn.Module):
    ...
    bias_ih: Incomplete
    bias_hh: Incomplete
    def __init__(self, input_size, hidden_size, bias: bool = ..., num_chunks: int = ..., dtype=...) -> None: ...
    def extra_repr(self): ...
...
class RNNCell(RNNCellBase):
    ...
    def __init__(self, input_size, hidden_size, bias: bool = ..., nonlinearity: str = ..., dtype=...) -> None: ...
...
class GRUCell(RNNCellBase):
    def __init__(self, input_size, hidden_size, bias: bool = ..., dtype=...) -> None: ...
    def forward(self, input: Tensor, hx: Optional[Tensor] = ...) -> Tensor: ...
    @classmethod
    def from_float(cls, mod): ...
