...
def split(tensor: Tensor, split_size_or_sections: Union[int, List[int]], dim: int = ...) -> List[Tensor]: ...
...
def norm(input, p: str = ..., dim: Incomplete | None = ..., keepdim: bool = ..., out: Incomplete | None = ..., dtype: Incomplete | None = ...): ...
