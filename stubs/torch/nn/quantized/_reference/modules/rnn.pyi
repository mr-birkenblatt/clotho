...
class RNNCellBase(nn.RNNCellBase):
    def __init__(self, input_size: int, hidden_size: int, bias: bool, num_chunks: int, device: Incomplete | None = ..., dtype: Incomplete | None = ..., weight_qparams_dict: Incomplete | None = ...) -> None: ...
...
class RNNCell(RNNCellBase):
    ...
    def __init__(self, input_size: int, hidden_size: int, bias: bool = ..., nonlinearity: str = ..., device: Incomplete | None = ..., dtype: Incomplete | None = ..., weight_qparams_dict: Optional[Dict[str, Dict[str, Any]]] = ...) -> None: ...
    def forward(self, input: Tensor, hx: Optional[Tensor] = ...) -> Tensor: ...
    @classmethod
    def from_float(cls, mod, weight_qparams_dict): ...

class LSTMCell(RNNCellBase):
    def __init__(self, input_size: int, hidden_size: int, bias: bool = ..., device: Incomplete | None = ..., dtype: Incomplete | None = ..., weight_qparams_dict: Optional[Dict[str, Dict[str, Any]]] = ...) -> None: ...
...
class RNNBase(nn.RNNBase):
    def __init__(self, mode: str, input_size: int, hidden_size: int, num_layers: int = ..., bias: bool = ..., batch_first: bool = ..., dropout: float = ..., bidirectional: bool = ..., proj_size: int = ..., device: Incomplete | None = ..., dtype: Incomplete | None = ..., weight_qparams_dict: Optional[Dict[str, Dict[str, Any]]] = ...) -> None: ...
