...
def approx_equal(lhs, rhs, tolerance: float = ...): ...
...
class _NnapiSerializer:
    ...
    def __init__(self, config, use_int16_for_qint16: bool = ...) -> None: ...
    ...
    def get_constant_value(
        self, jitval, typekind: Incomplete | None = ...): ...

    def operand_to_template_torchscript(
        self, op_id, oper, shape: Incomplete | None = ...): ...

    def forward_operand_shape(
        self, out_op_id, out_dim, in_op_id, in_dim) -> None: ...
    ...
    def get_conv_pool_args_2d_from_jit(
        ...
        dilation: Incomplete | None = ..., group: Incomplete | None = ...): ...

    def get_conv_pool_args_2d_common(
        self, kernel_size, strides, paddings, dilations, group_num): ...

    def serialize_model(
        self, model, inputs, return_shapes: Incomplete | None = ...): ...
    ...
    def add_pointwise_simple_binary_broadcast_op(
        self, node, opcode, fuse_code) -> None: ...
    ...
    def add_addmm_or_linear(
        self, node, transpose_weight, jit_input, jit_weight,
        jit_bias) -> None: ...

    def add_qlinear(self, node) -> None: ...

    def get_optional_bias(
        self, jit_bias, weight_tensor, transpose: bool = ...): ...

    def add_conv2d(self, node): ...
    def add_conv_underscore(self, node): ...
    def add_log_softmax(self, node) -> None: ...
    def add_qconv2d(self, node, fuse_code, transpose: bool = ...): ...

    def add_conv2d_common(
        self, jit_out, out_scale, out_zero_point, jit_image, weight_tensor,
        bias_id, args, transpose, fuse_code) -> None: ...
