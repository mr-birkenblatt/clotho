...
class DataLoader:
    ...
    def __init__(self, dataset: Dataset[T_co], batch_size: Optional[int] = ..., shuffle: Optional[bool] = ..., sampler: Union[Sampler, Iterable, None] = ..., batch_sampler: Union[Sampler[Sequence], Iterable[Sequence], None] = ..., num_workers: int = ..., collate_fn: Optional[_collate_fn_t] = ..., pin_memory: bool = ..., drop_last: bool = ..., timeout: float = ..., worker_init_fn: Optional[_worker_init_fn_t] = ..., multiprocessing_context: Incomplete | None = ..., generator: Incomplete | None = ..., *, prefetch_factor: int = ..., persistent_workers: bool = ..., pin_memory_device: str = ...) -> None: ...
    @property
