...
class QuantizeHandler(ABC):
    ...
    num_tensor_args: int
    def __init__(self, node_pattern: NodePattern, modules: Dict[str, torch.nn.Module], root_node_getter: Callable = ..., is_custom_module: bool = ..., is_standalone_module: bool = ...) -> None: ...
    def input_output_observed(self) -> bool: ...
    def is_general_tensor_value_op(self) -> bool: ...
    def get_activation_ctr(self, qconfig: Any, pattern: Pattern, is_training: bool) -> Optional[Callable]: ...
