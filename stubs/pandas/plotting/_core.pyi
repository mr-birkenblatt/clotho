...
class PlotAccessor(PandasObject):
    ...
    def hist(
            self, by: Optional[Any] = ...,
            bins: int = ..., **kwargs: Any) -> Any:
        ...

    def kde(
            self, bw_method: Optional[Any] = ...,
            ind: Optional[Any] = ..., **kwargs: Any) -> Any:
        ...
    ...
    def scatter(
            self, x: Any, y: Any, s: Optional[Any] = ...,
            c: Optional[Any] = ..., **kwargs: Any) -> Any:
        ...

    def hexbin(
            self, x: Any, y: Any, C: Optional[Any] = ...,
            reduce_C_function: Optional[Any] = ...,
            gridsize: Optional[Any] = ..., **kwargs: Any) -> Any:
        ...
