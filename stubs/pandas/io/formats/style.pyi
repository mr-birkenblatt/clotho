...
class Styler:
    ...
    def __init__(
            self, data: Any, precision: Optional[Any] = ...,
            table_styles: Optional[Any] = ..., uuid: Optional[Any] = ...,
    ...
    def to_excel(
            ...
            verbose: bool = ..., freeze_panes: Optional[Any] = ...) -> None:
        ...
    ...
    def apply(
            self, func: Any, axis: int = ..., subset: Optional[Any] = ...,
            **kwargs: Any) -> Any:
        ...

    def applymap(
            self, func: Any, subset: Optional[Any] = ...,
            **kwargs: Any) -> Any:
        ...

    def where(
            self, cond: Any, value: Any, other: Optional[Any] = ...,
            subset: Optional[Any] = ..., **kwargs: Any) -> Any:
        ...
    ...
    def background_gradient(
            self, cmap: str = ..., low: int = ..., high: int = ...,
            axis: int = ..., subset: Optional[Any] = ...,
            text_color_threshold: float = ...) -> Any:
        ...

    def set_properties(
            self, subset: Optional[Any] = ..., **kwargs: Any) -> Any:
        ...

    def bar(
            self, subset: Optional[Any] = ..., axis: int = ...,
            color: str = ..., width: int = ..., align: str = ...,
            vmin: Optional[Any] = ..., vmax: Optional[Any] = ...) -> Any:
        ...

    def highlight_max(
            self, subset: Optional[Any] = ...,
            color: str = ..., axis: int = ...) -> Any:
        ...
