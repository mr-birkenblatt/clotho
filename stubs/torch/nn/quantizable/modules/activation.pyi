...
class MultiheadAttention(nn.MultiheadAttention):
    ...
    def __init__(self, embed_dim: int, num_heads: int, dropout: float = ..., bias: bool = ..., add_bias_kv: bool = ..., add_zero_attn: bool = ..., kdim: int = ..., vdim: int = ..., batch_first: bool = ..., device: Incomplete | None = ..., dtype: Incomplete | None = ...) -> None: ...
    @classmethod
