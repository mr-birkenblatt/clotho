...
class SpectralNorm:
    ...
    def __init__(
        self, name: str = ..., n_power_iterations: int = ..., dim: int = ...,
        eps: float = ...) -> None: ...

    def reshape_weight_to_matrix(
        self, weight: torch.Tensor) -> torch.Tensor: ...

    def compute_weight(
        self, module: Module, do_power_iteration: bool) -> torch.Tensor: ...
    ...
    @staticmethod
    def apply(
        module: Module, name: str, n_power_iterations: int, dim: int,
...
def spectral_norm(
    module: T_module, name: str = ..., n_power_iterations: int = ...,
    eps: float = ..., dim: Optional[int] = ...) -> T_module: ...
