...
def validate_args_and_kwargs(
        fname: Any, args: Any, kwargs: Any, max_fname_arg_count: Any,
        compat_args: Any) -> None:
    ...
...
def validate_axis_style_args(
        data: Any, args: Any, kwargs: Any, arg_name: Any,
        method_name: Any) -> None:
    ...


def validate_fillna_kwargs(
        value: Any, method: Any,
        validate_scalar_dict_value: bool = ...) -> None:
    ...
