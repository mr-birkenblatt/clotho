...
def caching_allocator_alloc(size, device: Union[Device, int] = ..., stream: Incomplete | None = ...): ...
def caching_allocator_delete(mem_ptr) -> None: ...
def set_per_process_memory_fraction(fraction, device: Union[Device, int] = ...) -> None: ...
