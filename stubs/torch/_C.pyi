...
class CallStack:
    def __init__(self, arg0: str, arg1: _jit_tree_views.SourceRange) -> None: ...
...
class CompilationUnit:
    ...
    def define(self, src: str, rcb: Callable[[str],object] = ..., _frames_up: int = ...) -> None: ...
...
class ConcreteModuleType:
    def __init__(self, *args, **kwargs) -> None: ...
    def _create_hooks(self, arg0: List[_jit_tree_views.Def], arg1: List[Callable[[str],object]], arg2: List[_jit_tree_views.Def], arg3: List[Callable[[str],object]]) -> None: ...
    def _create_methods_and_properties(self, arg0: List[_jit_tree_views.Property], arg1: List[Callable[[str],object]], arg2: List[_jit_tree_views.Def], arg3: List[Callable[[str],object]], arg4: List[Dict[str,object]]) -> None: ...
    def dump(self) -> None: ...
    @overload
...
class ConcreteModuleTypeBuilder:
    ...
    def add_attribute(self, arg0: str, arg1: Type, arg2: bool, arg3: bool) -> None: ...
    ...
    def add_function_attribute(self, arg0: str, arg1: Type, arg2: object) -> None: ...
...
class FileCheck:
    ...
    @overload
    def check_count(self, str: str, count: int, exactly: bool = ...) -> FileCheck: ...
...
class FunctionSchema:
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    def check_forward_compatible_with(self, arg0: FunctionSchema) -> Tuple[bool,str]: ...
...
class Graph:
    ...
    def _pretty_print_onnx(self, initializers, onnx_opset_version: int = ..., defer_weight_export: bool = ..., operator_export_type: _onnx.OperatorExportTypes = ..., google_printer: bool = ..., keep_initializers_as_inputs: bool = ..., custom_opsets: Dict[str,int], add_node_names: bool = ...) -> str: ...
    def addInput(self, *args, **kwargs) -> Any: ...
    def alias_db(self, isFrozen: bool = ..., descend_function_calls: bool = ...) -> AliasDb: ...
...
class LockingLogger(LoggerBase):
    ...
    def set_aggregation_type(self, arg0: str, arg1: AggregationType) -> None: ...
...
class ScriptFunction:
    ...
    def save(self, filename: str, _extra_files: Dict[str,str] = ...) -> None: ...
...
class ScriptModule(torch.ScriptObject):
    ...
    def _create_method_from_trace(self, name: str, func: function, input_tuple: tuple, var_name_lookup_fn: function, strict: bool, force_outplace: bool, argument_names: List[str] = ...) -> None: ...
    def _define(self, arg0, arg1: str, arg2: Callable[[str],object]) -> None: ...
    def _get_forward_hooks(self, *args, **kwargs) -> Any: ...
    def _get_forward_pre_hooks(self, *args, **kwargs) -> Any: ...
    def _register_attribute(self, arg0: str, arg1: Type, arg2: handle) -> None: ...
    def _replicate_for_data_parallel(self) -> ScriptModule: ...
    def _save_for_mobile(self, filename: str, _extra_files: Dict[str,str] = ..., _save_mobile_debug_info: bool = ..., _use_flatbuffer: bool = ...) -> None: ...
    def _save_to_buffer_for_mobile(self, _extra_files: Dict[str,str] = ..., _save_mobile_debug_info: bool = ..., _use_flatbuffer: bool = ...) -> bytes: ...
    ...
    def dump(self, code: bool = ..., attrs: bool = ..., params: bool = ...) -> None: ...
    def dump_to_str(self, code: bool = ..., attrs: bool = ..., params: bool = ...) -> str: ...
    def get_debug_state(self) -> GraphExecutorState: ...
    def save(self, filename: str, _extra_files: Dict[str,str] = ...) -> None: ...
    def save_to_buffer(self, _extra_files: Dict[str,str] = ...) -> bytes: ...
...
class StaticModule:
    ...
    def benchmark_individual_ops(self, arg0, arg1, arg2: int, arg3: int) -> StaticModule.IndividualMetrics: ...
    def __call__(self, *args, **kwargs) -> object: ...
...
class _DispatchModule:
    ...
    def impl_tt_t(self, name: str, dispatch: str = ..., debug: str = ...) -> object: ...
...
center = ..., normalized = ..., onesided = ..., length = ...) -> Tensor: ...
    ...
    def new(self, *args, **kwargs) -> Any: ...
    def new_empty(self, size, dtype = ..., device = ..., requires_grad = ...) -> Tensor: ...
    def new_empty_strided(self, size, stride, dtype = ..., device = ..., requires_grad = ...) -> Tensor: ...
    def new_full(self, size, fill_value, dtype = ..., device = ..., requires_grad = ...) -> Tensor: ...
    def new_ones(self, size, dtype = ..., device = ..., requires_grad = ...) -> Tensor: ...
    @overload
    def new_tensor(self, data, dtype = ..., device = ..., requires_grad = ...) -> Tensor: ...
    @overload
    def new_tensor() -> Any: ...
    @overload
    ...
    def new_zeros(self, size, dtype = ..., device = ..., requires_grad = ...) -> Tensor: ...
    ...
    def stft(self, frame_length, hop, fft_size = ..., return_onesided = ..., window = ..., pad_end = ...) -> Tensor: ...
    @overload
    ...
    @overload
    def to(device = ..., dtype = ..., non_blocking = ..., copy = ..., memory_format = ...) -> Tensor: ...
    @overload
...
class _VariableFunctionsClass:
    ...
    def _amp_foreach_non_finite_check_and_unscale_(self, *args, **kwargs) -> Any: ...
    ...
    def _fake_quantize_learnable_per_channel_affine(self, *args, **kwargs) -> Any: ...
    def _fake_quantize_learnable_per_tensor_affine(self, *args, **kwargs) -> Any: ...
    def _fake_quantize_per_tensor_affine_cachemask_tensor_qparams(self, *args, **kwargs) -> Any: ...
    ...
    def _nested_from_padded_and_nested_example(self, *args, **kwargs) -> Any: ...
    ...
    def _validate_sparse_compressed_tensor_args(self, *args, **kwargs) -> Any: ...
    ...
    def fbgemm_linear_fp16_weight_fp32_activation(self, *args, **kwargs) -> Any: ...
    def fbgemm_linear_int8_weight(self, *args, **kwargs) -> Any: ...
    def fbgemm_linear_int8_weight_fp32_activation(self, *args, **kwargs) -> Any: ...
...
def _create_function_from_trace(name: str, func: function, input_tuple: tuple, var_name_lookup_fn: function, strict: bool, force_outplace: bool, argument_names: List[str] = ...) -> ScriptFunction: ...
def _create_graph_by_tracing(func: function, inputs: List[IValue], var_name_lookup_fn: function, strict: bool, force_outplace: bool, self = ..., argument_names: List[str] = ...) -> Tuple[Graph,List[IValue]]: ...
...
def _get_cublas_allow_fp16_reduced_precision_reduction(*args, **kwargs) -> Any: ...
...
def _get_graph_executor_optimize(new_settings: Optional[bool] = ...) -> bool: ...
...
def _jit_nvfuser_set_comparison_callback(arg0: bool, arg1: function) -> None: ...
...
def _jit_pass_onnx_assign_output_shape(arg0, arg1, arg2, arg3: bool, arg4: bool) -> None: ...
...
def _jit_pass_onnx_graph_shape_type_inference(arg0, arg1: Dict[str,IValue], arg2: int) -> None: ...
...
def _jit_pass_onnx_unpack_quantized_weights(arg0, arg1: Dict[str,IValue], arg2: bool) -> Dict[str,IValue]: ...
...
def _jit_pass_propagate_shapes_on_graph_and_build_compute(*args, **kwargs) -> Any: ...
...
def _jit_to_backend_selective(arg0: handle, arg1: function, arg2: List[str]) -> object: ...
@overload
...
def _propagate_and_assign_input_shapes(arg0: Graph, arg1, arg2: List[int], arg3: bool, arg4: bool) -> Graph: ...
...
def _select_conv_backend(arg0, arg1, arg2, arg3, arg4, arg5, arg6: bool, arg7, arg8: int) -> _ConvBackend: ...
...
def _set_cublas_allow_fp16_reduced_precision_reduction(*args, **kwargs) -> Any: ...
...
def import_ir_module(arg0: CompilationUnit, arg1: str, arg2: object, arg3: dict) -> ScriptModule: ...
def import_ir_module_from_buffer(arg0: CompilationUnit, arg1: str, arg2: object, arg3: dict) -> ScriptModule: ...
@overload
...
def merge_type_from_type_comment(arg0: _jit_tree_views.Decl, arg1: _jit_tree_views.Decl, arg2: bool) -> _jit_tree_views.Decl: ...
