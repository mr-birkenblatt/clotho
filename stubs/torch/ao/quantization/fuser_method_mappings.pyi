...
def get_fuser_method(op_list, additional_fuser_method_mapping: Incomplete | None = ...): ...
...
def get_fuser_method_new(op_pattern: Pattern, fuser_method_mapping: Optional[Dict[Pattern, Union[nn.Sequential, Callable]]] = ...): ...
