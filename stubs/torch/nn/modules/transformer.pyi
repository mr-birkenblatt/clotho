...
class Transformer(Module):
    ...
    def __init__(self, d_model: int = ..., nhead: int = ..., num_encoder_layers: int = ..., num_decoder_layers: int = ..., dim_feedforward: int = ..., dropout: float = ..., activation: Union[str, Callable[[Tensor], Tensor]] = ..., custom_encoder: Optional[Any] = ..., custom_decoder: Optional[Any] = ..., layer_norm_eps: float = ..., batch_first: bool = ..., norm_first: bool = ..., device: Incomplete | None = ..., dtype: Incomplete | None = ...) -> None: ...
...
class TransformerEncoder(Module):
    ...
    def __init__(self, encoder_layer, num_layers, norm: Incomplete | None = ..., enable_nested_tensor: bool = ...) -> None: ...
...
class TransformerDecoder(Module):
    ...
    num_layers: Incomplete
    norm: Incomplete
    def __init__(self, decoder_layer, num_layers, norm: Incomplete | None = ...) -> None: ...
...
class TransformerEncoderLayer(Module):
    ...
    def __init__(self, d_model: int, nhead: int, dim_feedforward: int = ..., dropout: float = ..., activation: Union[str, Callable[[Tensor], Tensor]] = ..., layer_norm_eps: float = ..., batch_first: bool = ..., norm_first: bool = ..., device: Incomplete | None = ..., dtype: Incomplete | None = ...) -> None: ...
