...
def prelu_backward(
    grad_output: Tensor, self: Tensor, weight: Tensor) -> Tuple[
        Tensor, Tensor]: ...
...
def logit_backward(
    grad_output: Tensor, self: Tensor, eps: Optional[
            float] = ...) -> Tensor: ...
...
def native_layer_norm_backward(
    ...
    bias: Optional[Tensor], output_mask: List[bool]) -> Tuple[Optional[
...
def native_batch_norm(
    ...
    training: bool, momentum: float, eps: float) -> Tuple[
