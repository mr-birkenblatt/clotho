...
class IndependentTransform(Transform):
    ...
    def __init__(self, base_transform, reinterpreted_batch_ndims, cache_size: int = ...) -> None: ...
    def with_cache(self, cache_size: int = ...): ...
    def domain(self): ...
    def codomain(self): ...
    @property
...
class AffineTransform(Transform):
    ...
    loc: Incomplete
    scale: Incomplete
    def __init__(self, loc, scale, event_dim: int = ..., cache_size: int = ...) -> None: ...
    @property
    def event_dim(self): ...
    def domain(self): ...
    def codomain(self): ...
...
class CorrCholeskyTransform(Transform):
    ...
    codomain: Incomplete
    bijective: bool
    def log_abs_det_jacobian(self, x, y, intermediates: Incomplete | None = ...): ...
    def forward_shape(self, shape): ...
    def inverse_shape(self, shape): ...
...
class CatTransform(Transform):
    ...
    lengths: Incomplete
    dim: Incomplete
    def __init__(self, tseq, dim: int = ..., lengths: Incomplete | None = ..., cache_size: int = ...) -> None: ...
    def event_dim(self): ...
    def length(self): ...
    def with_cache(self, cache_size: int = ...): ...
    def log_abs_det_jacobian(self, x, y): ...
...
class StackTransform(Transform):
    transforms: List[Transform]
    dim: Incomplete
    def __init__(self, tseq, dim: int = ..., cache_size: int = ...) -> None: ...
    def with_cache(self, cache_size: int = ...): ...
    def log_abs_det_jacobian(self, x, y): ...
    @property
    def bijective(self): ...
