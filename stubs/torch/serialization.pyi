...
def check_module_version_greater_or_equal(module, req_version_tuple, error_if_malformed: bool = ...): ...
...
def save(obj, f: Union[str, os.PathLike, BinaryIO, IO[bytes]], pickle_module=..., pickle_protocol=..., _use_new_zipfile_serialization: bool = ...) -> None: ...
def load(f, map_location: Incomplete | None = ..., pickle_module=..., **pickle_load_args): ...
