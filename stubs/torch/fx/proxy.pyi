...
class TracerBase:
    ...
    def create_proxy(self, kind: str, target: Target, args: Tuple[Any, ...], kwargs: Dict[str, Any], name: Optional[str] = ..., type_expr: Optional[Any] = ..., proxy_factory_fn: Callable[[Node], 'Proxy'] = ...): ...
...
class Proxy:
    ...
    @classmethod
    def __torch_function__(cls, orig_method, types, args: Incomplete | None = ..., kwargs: Incomplete | None = ...): ...
