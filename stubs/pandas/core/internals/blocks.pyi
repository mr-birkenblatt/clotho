...
class Block(PandasObject):
    ...
    def make_block_same_class(
            self, values: Any, placement: Optional[Any] = ...,
            ndim: Optional[Any] = ...,
    ...
    def fillna(
            self, value: Any, limit: Optional[Any] = ...,
    ...
    def to_native_types(
            self, slicer: Optional[Any] = ..., na_rep: str = ...,
...
def make_block(
        values: Any, placement: Any, klass: Optional[Any] = ...,
...
def _block_shape(
        values: Any, ndim: int = 1,
        shape: Optional[Any] = None) -> Any:
    ...


def _merge_blocks(
        blocks: Any, dtype: Optional[Any] = None,
