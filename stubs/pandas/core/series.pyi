...
class Series(base.IndexOpsMixin, generic.NDFrame):
    ...
    @classmethod
    def from_array(
            cls, arr: Any, index: Optional[Any] = ...,
    ...
    def to_string(
            self, buf: Optional[Any] = ..., na_rep: str = ...,
    ...
    def idxmin(
            self, axis: int = ..., skipna: bool = ..., *args: Any,
            **kwargs: Any) -> Any:
        ...
    ...
    def _binop(
            self, other: Any, func: Any, level: Optional[Any] = None,
    ...
    def aggregate(
            self, func: Any, axis: int = ..., *args: Any,
            **kwargs: Any) -> Any:
        ...
    ...
    def apply(
            self, func: Any, convert_dtype: bool = ..., args: Any = ...,
            **kwds: Any) -> Any:
        ...
