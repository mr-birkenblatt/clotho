...
class BaseGrouper:
    ...
    def __init__(
            self, axis: Any, groupings: Any, sort: bool = ...,
    ...
    def aggregate(
            self, values: Any, how: Any, axis: int = ...,
            min_count: int = ...) -> Any:
        ...
...
class BinGrouper(BaseGrouper):
    ...
    def __init__(
            self, bins: Any, binlabels: Any, filter_empty: bool = ...,
...
class DataSplitter:
    ...
    def __init__(
            self, data: Any, labels: Any, ngroups: Any,
            axis: int = ...) -> None:
        ...
