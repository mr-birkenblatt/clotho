...
class _NnapiSerializer:
    ...
    def get_constant_value(self, jitval, typekind: Incomplete | None = ...): ...
    def operand_to_template_torchscript(self, op_id, oper, shape: Incomplete | None = ...): ...
    ...
    def get_conv_pool_args_2d_from_jit(self, kernel_size, stride, padding, dilation: Incomplete | None = ..., group: Incomplete | None = ...): ...
    def get_conv_pool_args_2d_common(self, kernel_size, strides, paddings, dilations, group_num): ...
    def serialize_model(self, model, inputs, return_shapes: Incomplete | None = ...): ...
    ...
    def get_optional_bias(self, jit_bias, weight_tensor, transpose: bool = ...): ...
...
def serialize_model(module, inputs, *, config: Incomplete | None = ..., return_shapes: Incomplete | None = ..., use_int16_for_qint16: bool = ...): ...
