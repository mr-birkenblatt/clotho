...
class BatcherIterDataPipe(IterDataPipe[DataChunk]):
    ...
    def __init__(self, datapipe: IterDataPipe, batch_size: int, drop_last: bool = ..., wrapper_class=...) -> None: ...
...
class UnBatcherIterDataPipe(IterDataPipe):
    ...
    def __init__(self, datapipe: IterDataPipe, unbatch_level: int = ...) -> None: ...
    def __iter__(self): ...
...
class GrouperIterDataPipe(IterDataPipe[DataChunk]):
    ...
    wrapper_class: Incomplete
    def __init__(self, datapipe: IterDataPipe[T_co], group_key_fn: Callable, *, buffer_size: int = ..., group_size: Optional[int] = ..., guaranteed_group_size: Optional[int] = ..., drop_remaining: bool = ...) -> None: ...
    def __iter__(self): ...
    def reset(self) -> None: ...
