...
def elu(self, alpha: float = ..., scale: float = ..., input_scale: float = ...) -> Tensor: ...
...
def l1_loss_backward(grad_output: Tensor, self: Tensor, target: Tensor, reduction: int = ...): ...
...
def huber_loss(self, target: Tensor, reduction: int = ..., delta: float = ...) -> Tensor: ...
...
def binary_cross_entropy(self, target: Tensor, weight: Optional[Tensor] = ..., reduction: int = ...) -> Tensor: ...
...
def col2im_backward(grad_output: Tensor, kernel_size: List[int], dilation: List[int], padding: List[int], stride: List[int]) -> Tensor: ...
...
def prod(x: List[int]): ...
def split_with_sizes(self, split_sizes: List[int], dim: int = ...) -> List[Tensor]: ...
def split(self, split_size: int, dim: int = ...) -> List[Tensor]: ...
def addmm(self, mat1: Tensor, mat2: Tensor, beta: int = ..., alpha: int = ...): ...
...
def var_correction(x: Tensor, dims: Optional[List[int]], correction: Optional[int] = ..., keepdim: bool = ...): ...
def std_decomposition(x: Tensor, dims: List[int], correction: int = ..., keepdim: bool = ...): ...
