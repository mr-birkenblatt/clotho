...
class MetaTracer(torch.fx.Tracer):
    ...
    def create_proxy(self, kind, target, args, kwargs, name: Incomplete | None = ..., type_expr: Incomplete | None = ..., proxy_factory_fn: Incomplete | None = ...): ...
    ...
    orig_fns: Incomplete
    def trace(self, root, meta_args: Dict[str, torch.Tensor], concrete_args: Incomplete | None = ...): ...

def symbolic_trace(root: Union[torch.nn.Module, Callable[..., Any]], meta_args: Dict[str, torch.Tensor] = ..., concrete_args: Optional[Dict[str, Any]] = ...) -> torch.fx.GraphModule: ...
