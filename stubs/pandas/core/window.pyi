...
class _Rolling_and_Expanding(_Rolling):
    ...
    def std(self, ddof: int = 1, **kwargs: Any) -> Any:
        ...

    def var(self, ddof: int = 1, **kwargs: Any) -> Any:
        ...
...
class EWM(_Rolling):
    ...
    def std(self, bias: bool = ..., **kwargs: Any) -> Any:
        ...

    vol: Any = ...

    def var(self, bias: bool = ..., **kwargs: Any) -> Any:
        ...
