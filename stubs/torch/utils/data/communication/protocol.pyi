...
class MapDataPipeQueueProtocolClient(ProtocolClient):
    ...
    def get_response_len(self, block: bool = ..., timeout: Incomplete | None = ...): ...
    def get_response_item(self, block: bool = ..., timeout: Incomplete | None = ...): ...
...
class IterDataPipeQueueProtocolClient(ProtocolClient):
    ...
    def get_response_next(self, block: bool = ..., timeout: Incomplete | None = ...): ...
