...
class Node:
    ...
    type: Incomplete
    meta: Incomplete
    def __init__(self, graph: Graph, name: str, op: str, target: Target, args: Tuple['Argument', ...], kwargs: Dict[str, 'Argument'], return_type: Optional[Any] = ...): ...
    @property
    def next(self) -> Node: ...
    @property
    def prev(self) -> Node: ...
    ...
    def replace_all_uses_with(self, replace_with: Node, delete_user_cb: Callable[[Node], bool] = ...) -> List['Node']: ...
    def is_impure(self): ...
