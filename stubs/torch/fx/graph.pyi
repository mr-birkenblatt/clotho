...
class Graph:
    ...
    def graph_copy(self, g: Graph, val_map: Dict[Node, Node], return_output_node: bool = ...) -> Optional[Argument]: ...
    ...
    def call_function(self, the_function: Callable[..., Any], args: Optional[Tuple['Argument', ...]] = ..., kwargs: Optional[Dict[str, 'Argument']] = ..., type_expr: Optional[Any] = ...) -> Node: ...
