...
def to_hdf(
        path_or_buf: Any, key: Any, value: Any, mode: Optional[Any] = ...,
...
def read_hdf(
        path_or_buf: Any, key: Optional[Any] = ..., mode: str = ...,
        **kwargs: Any) -> Any:
    ...
...
class HDFStore:
    def __init__(
            self, path: Any, mode: Optional[Any] = ...,
    ...
    def select(
            self, key: Any, where: Optional[Any] = ...,
    ...
    def select_as_multiple(
            self, keys: Any, where: Optional[Any] = ...,
    ...
    def put(
            self, key: Any, value: Any, format: Optional[Any] = ...,
    ...
    def append_to_multiple(
            self, d: Any, value: Any, selector: Any,
    ...
    def copy(
            self, file: Any, mode: str = ..., propindexes: bool = ...,
...
class TableIterator:
    ...
    def __init__(
            self, store: Any, s: Any, func: Any, where: Any, nrows: Any,
            start: Optional[Any] = ..., stop: Optional[Any] = ...,
...
class IndexCol:
    ...
    def __init__(
            self, values: Optional[Any] = ..., kind: Optional[Any] = ...,
    ...
    def convert(
            self, values: Any, nan_rep: Any, encoding: Any, errors: Any,
            start: Optional[Any] = ..., stop: Optional[Any] = ...) -> Any:
        ...
...
class GenericIndexCol(IndexCol):
    ...
    def convert(
            self, values: Any, nan_rep: Any, encoding: Any,
...
class DataCol(IndexCol):
    ...
    def set_atom(
            self, block: Any, block_items: Any, existing_col: Any,
...
class Fixed:
    ...
    def __init__(
            self, parent: Any, group: Any, encoding: Optional[Any] = ...,
    ...
    def delete(
            self, where: Optional[Any] = ..., start: Optional[Any] = ...,
...
class GenericFixed(Fixed):
    ...
    def read_array(
            self, key: Any, start: Optional[Any] = ...,
            stop: Optional[Any] = ...) -> Any:
        ...
    ...
    def read_index_node(
            self, node: Any, start: Optional[Any] = ...,
            stop: Optional[Any] = ...) -> Any:
        ...
...
class Table(Fixed):
    ...
    def validate_data_columns(
            self, data_columns: Any,
            min_itemsize: Any) -> Any:
        ...

    def create_axes(
            self, axes: Any, obj: Any, validate: bool = ...,
    ...
    def read_column(
            self, column: Any, where: Optional[Any] = ...,
            start: Optional[Any] = ...,
            stop: Optional[Any] = ...) -> Any:
        ...
...
class AppendableTable(LegacyTable):
    ...
    def write_data_chunk(
            self, rows: Any, indexes: Any, mask: Any,
            values: Any) -> None:
        ...
...
class AppendableFrameTable(AppendableTable):
    ...
    def read(
            self, where: Optional[Any] = ..., columns: Optional[Any] = ...,
            **kwargs: Any) -> Any:
        ...
...
class Selection:
    ...
    def __init__(
            self, table: Any, where: Optional[Any] = ...,
            start: Optional[Any] = ...,
