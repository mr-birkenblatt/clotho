...
def embedding_bag(g, embedding_matrix, indices, offsets, scale_grad_by_freq, mode, sparse, per_sample_weights, include_last_offset, padding_idx): ...
...
def split(g, self, split_size_or_sizes, dim, _outputs: Incomplete | None = ...): ...
def unsafe_split(g, self, split_size_or_sizes, dim, _outputs: Incomplete | None = ...): ...
def split_with_sizes(g, self, split_sizes, dim, _outputs: Incomplete | None = ...): ...
def unsafe_split_with_sizes(g, self, split_sizes, dim, _outputs: Incomplete | None = ...): ...
...
def where(g, condition, self: Incomplete | None = ..., other: Incomplete | None = ..., _outputs: Incomplete | None = ...): ...
...
def bucketize(g, self, boundaries, out_int32: bool = ..., right: bool = ...): ...
...
def max(g, self, dim_or_y: Incomplete | None = ..., keepdim: Incomplete | None = ...): ...
def maximum(g, input, other): ...
def min(g, self, dim_or_y: Incomplete | None = ..., keepdim: Incomplete | None = ...): ...
...
def empty_like(g, input, dtype: Incomplete | None = ..., layout: Incomplete | None = ..., device: Incomplete | None = ..., pin_memory: bool = ..., memory_format: Incomplete | None = ...): ...
def new_empty(g, self, sizes, dtype, layout, device, pin_memory: bool = ...): ...
def scalar_tensor(g, scalar, dtype, *options): ...
def tensor(g, data, dtype: Incomplete | None = ..., device: Incomplete | None = ..., requires_grad: bool = ...): ...
def as_tensor(g, data, dtype: Incomplete | None = ..., device: Incomplete | None = ...): ...
def zeros(g, sizes, dtype, layout, device, pin_memory: bool = ...): ...
def zeros_like(g, input, dtype: Incomplete | None = ..., layout: Incomplete | None = ..., device: Incomplete | None = ..., pin_memory: bool = ..., memory_format: Incomplete | None = ...): ...
def new_zeros(g, self, sizes, dtype, layout, device, pin_memory: bool = ...): ...
def ones(g, sizes, dtype, layout, device, pin_memory: bool = ...): ...
def ones_like(g, input, dtype: Incomplete | None = ..., layout: Incomplete | None = ..., device: Incomplete | None = ..., pin_memory: bool = ..., memory_format: Incomplete | None = ...): ...
def new_ones(g, self, sizes, dtype, layout, device, pin_memory: bool = ...): ...
def full(g, sizes, value, dtype, layout, device, pin_memory: bool = ...): ...
def full_like(g, input, fill_value, dtype: Incomplete | None = ..., layout: Incomplete | None = ..., device: Incomplete | None = ..., pin_memory: bool = ..., memory_format: Incomplete | None = ...): ...
def new_full(g, self, size, fill_value, dtype, layout, device, pin_memory: bool = ...): ...
def eye(g, *args): ...
...
def repeat_interleave(g, self, repeats, dim: Incomplete | None = ..., output_size: Incomplete | None = ...): ...
...
def randn_like(g, self, dtype, layout: Incomplete | None = ..., device: Incomplete | None = ..., pin_memory: bool = ..., memory_format: Incomplete | None = ...): ...
def rand_like(g, self, dtype, layout: Incomplete | None = ..., device: Incomplete | None = ..., pin_memory: bool = ..., memory_format: Incomplete | None = ...): ...
def rrelu(g, input, lower, upper, training, generator): ...
def bernoulli(g, input, generator: Incomplete | None = ..., out: Incomplete | None = ...): ...
...
def frobenius_norm(g, self, dim: Incomplete | None = ..., keepdim: bool = ...): ...
def multinomial(g, input, num_samples, replacement: bool = ..., generator: Incomplete | None = ...): ...
...
def hann_window(g, window_length, periodic: bool = ..., dtype: Incomplete | None = ..., layout: Incomplete | None = ..., device: Incomplete | None = ..., pin_memory: Incomplete | None = ..., requires_grad: bool = ...): ...
def mv(g, self, vec): ...
