...
class _BufferCommHook:
    ...
    def __init__(
        self, buffer_comm_hook, buffer_comm_hook_state,
        buffer_comm_hook_location) -> None: ...
...
class DistributedDataParallel(Module, Joinable):
    ...
    def __init__(
        ...
        process_group: Incomplete | None = ..., bucket_cap_mb: int = ...,
        find_unused_parameters: bool = ..., check_reduction: bool = ...,
    ...
    def join(
        self, divide_by_initial_world_size: bool = ..., enable: bool = ...,
