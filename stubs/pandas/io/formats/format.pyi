...
class CategoricalFormatter:
    ...
    def __init__(
            self, categorical: Any, buf: Optional[Any] = ...,
...
class SeriesFormatter:
    ...
    def __init__(
            self, series: Any, buf: Optional[Any] = ...,
...
class DataFrameFormatter(TableFormatter):
    ...
    def __init__(
            self, frame: Any, buf: Optional[Any] = ...,
    ...
    def to_latex(
            self, column_format: Optional[Any] = ...,
    ...
    def to_html(
            self, classes: Optional[Any] = ..., notebook: bool = ...,
...
def format_array(
        values: Any, formatter: Any, float_format: Optional[Any] = ...,
...
class Timedelta64Formatter(GenericArrayFormatter):
    ...
    def __init__(
            self, values: Any, nat_rep: str = ..., box: bool = ...,
            **kwargs: Any) -> None:
        ...
