...
# pylint: disable=bad-mcs-method-argument,unexpected-special-method-signature
from typing import (
    Any,
    Callable,
    ClassVar,
...
class ConcreteModuleType:
    ...
    def _create_hooks(
        self, arg0: List[_jit_tree_views.Def],
        arg1: List[Callable[[str], object]],
        arg2: List[_jit_tree_views.Def],
        arg3: List[Callable[[str], object]]) -> None: ...
    ...
    def _create_methods_and_properties(
        ...
        arg3: List[Callable[[str], object]], arg4: List[Dict[
                        str, object]]) -> None: ...
...
class ScriptModule(torch.ScriptObject):
    ...
    def _register_attribute(
        self, arg0: str, arg1: Type, arg2: Any) -> None: ...
...
class _TensorBase:
    ...
    def chunk(self, chunks, dim=...) -> list[Tensor]: ...
    ...
    @overload
    def double(self) -> Any: ...
    def dsplit(self, split_size_or_sections) -> list[Tensor]: ...
    ...
    def hsplit(self, split_size_or_sections) -> list[Tensor]: ...
    ...
    def istft(
        self, n_fft, hop_length=..., win_length=..., window=...,
    ...
    @overload
    def size(self, dim=...) -> int | torch.Tensor: ...
    @overload
    def size(self) -> Any: ...
    @overload
    ...
    def tensor_split(
        self, indices_or_sections, dim=...) -> list[Tensor]: ...
    ...
    def type(
        self, dtype=..., non_blocking=..., **kwargs) -> Any: ...

    def type_as(self, tensor) -> 'Tensor': ...
    def unbind(self, dim=...) -> Any: ...
    def unflatten(self, *args, **kwargs) -> Any: ...
    def unfold(self, dimension, size, step) -> 'Tensor': ...
    def uniform_(self, from_=..., to=...) -> 'Tensor': ...
    def unsafe_chunk(self, chunks, dim=...) -> list[Tensor]: ...
    def unsafe_split(self, split_size, dim=...) -> list[Tensor]: ...
    ...
    @overload
    def var(self, unbiased=...) -> 'Tensor': ...
    def vdot(self, other) -> 'Tensor': ...
    @overload
    def view(self, *shape) -> 'Tensor': ...
    @overload
    def view(self, dtype) -> 'Tensor': ...
    @overload
    def view_as(self, other) -> 'Tensor': ...
    @overload
    def view_as(self, other) -> Any: ...
    def vsplit(self, split_size_or_sections) -> list[Tensor]: ...
...
def _get_operation_overload(arg0: str, arg1: str) -> Any: ...
...
def _jit_get_emit_hooks(
    ) -> Tuple[Callable[[ScriptModule], None], Callable[[
                        ScriptFunction], None]]: ...
...
def _jit_pass_custom_pattern_based_rewrite_graph(
    pattern: str, fused_node_name: str, g,
    value_name_pairs: List[Tuple[str, str]] = ...) -> None: ...
...
def _jit_pass_onnx_scalar_type_analysis(
    graph,
    lowprecision_cast: bool = ..., opset_version: int = ...) -> None: ...
...
def _jit_script_class_compile(
    arg0: str, arg1: _jit_tree_views.ClassDef,
    arg2: Dict[str, Dict[str, object]],
    arg3: Callable[[str], object]) -> ClassType: ...
...
def _jit_script_compile_overload(
    ...
    arg3: Callable[[str], object], arg4: Dict[
            str, object], arg5: object) -> ScriptFunction: ...
...
def _jit_set_emit_hooks(
    arg0: Callable[[ScriptModule], None],
    arg1: Callable[[ScriptFunction], None]) -> None: ...
...
def _jit_to_backend(arg0: str, arg1: Any, arg2: dict) -> object: ...


def _jit_to_backend_selective(
    arg0: Any, arg1: function, arg2: List[str]) -> object: ...
...
def _resolve_type(
    arg0: str, arg1: _jit_tree_views.SourceRange,
    arg2: Callable[[str], object]) -> Type: ...


def _resolve_type_from_object(
    arg0: object, arg1: _jit_tree_views.SourceRange,
    arg2: Callable[[str], object]) -> Type: ...
...
@overload
def set_flush_denormal(mode=True) -> Any: ...


@overload
def set_flush_denormal(mode=False) -> Any: ...
